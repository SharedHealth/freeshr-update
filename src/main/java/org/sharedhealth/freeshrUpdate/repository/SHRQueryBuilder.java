...
public class SHRQueryBuilder {
    ...
    public Update updateEncounterOnMergeStatement(EncounterBundle encounterBundle, String healthIdToMergeWith) {
        ...
        updateEncounter.with(set(getEncounterContentColumnName(), encounterBundle.getEncounterContent()))
                ...
                .and(eq(RECEIVED_AT_COLUMN_NAME, encounterBundle.getReceivedAtUuid()));
    ...
    public Statement updateEncounterQuery(PatientUpdate patientUpdate, EncounterDetail encountersDetail) {
        ...
        return update.where(eq(ENCOUNTER_ID_COLUMN_NAME, encountersDetail.getEncounterId())).
                and(eq(RECEIVED_AT_COLUMN_NAME, encountersDetail.getReceivedAtUuid()));
    }
    ...
    public Statement insertCatchmentFeedForAddressChange(PatientUpdate patientUpdate, EncounterDetail encounterDetail) {
        ...
        return getInsEncByCatchmentStmt(addressChange.getDivisionId(),
                addressChange.getConcatenatedDistrictId(), addressChange.getConcatenatedUpazilaId(),
                addressChange.getConcatenatedCityCorporationId(), addressChange.getConcatenatedWardId(),
                encounterDetail.getEncounterId(), createdAt, null);
    }

    public Insert getInsEncByCatchmentStmt(String divisionId, String concatenatedDistrictId,
                                           String concatenatedUpazillaId, String concatenatedCityCorporationId,
                                           String concatenatedWardId, String encounterId, UUID createdAt, UUID mergedAt) {
